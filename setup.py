...
def load_config() -> dict:
    """Load project metadata from config.json."""
...
def load_requirements() -> list:
    ...
    """
    deps = []
    # Some packages have different install name vs import name
    import_name_map = {
...
def run_setup() -> bool:
    ...
    try:
        config = load_config()
        print(f"Setting up {config.get('project')} v{config.get('version')}...\n")
